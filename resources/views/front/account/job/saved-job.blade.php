                                        ...
                                        <td>
                                            <div class="action-dots">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('jobDetail', $savedJob->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="removeSaveJob dropdown-item" data-id="{{ $savedJob->id }}"> <i class="fa fa-trash" aria-hidden="true"></i> Remove</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
...
@section('customJs')
<script>
      $('.removeSaveJob').click(function(event) {
