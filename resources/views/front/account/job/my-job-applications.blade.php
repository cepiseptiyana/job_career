                            ...
                            <table class="table">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        ...
                                        {{-- parse Carbon supaya manipulasi waktu --}}
                                        ...
                                        <td>
                                            <div class="action-dots">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('jobDetail', $jobApplication->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="removeMyApplliedJob dropdown-item" data-id="{{ $jobApplication->id }}"> <i class="fa fa-trash" aria-hidden="true"></i> Remove</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
...
@section('customJs')
<script>
    $('.removeMyApplliedJob').click(function(event) {
